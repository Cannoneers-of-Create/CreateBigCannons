...
public enum CBCParticleTypes {
	...
	DEBRIS_SMOKE_BURST(DebrisSmokeBurstParticleData::instance),
	DROP_MORTAR_PLUME(DropMortarPlumeParticleData::new),
	FLAK_CLOUD(FlakCloudParticleData::instance),
	FLAK_SMOKE(FlakSmokeParticleData::new),
	FLUID_BLOB(FluidBlobParticleData::new),
	FLUID_CLOUD(FluidCloudParticleData::instance),
	...
	QUICK_FIRING_BREECH_SMOKE(QuickFiringBreechSmokeParticleData::instance),
	...
	SHRAPNEL_CLOUD(ShrapnelCloudParticleData::instance),
