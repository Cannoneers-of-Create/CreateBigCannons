...
public class CBCEntityTypes {
    ...
    public static final EntityEntry<APAutocannonProjectile> AP_AUTOCANNON =
        autocannonProjectile("ap_autocannon", APAutocannonProjectile::new, "Armor Piercing (AP) Autocannon Round", CBCMunitionPropertiesHandlers.INERT_AUTOCANNON_PROJECTILE);

    public static final EntityEntry<FlakAutocannonProjectile> FLAK_AUTOCANNON =
        autocannonProjectile("flak_autocannon", FlakAutocannonProjectile::new, "Flak Autocannon Round", CBCMunitionPropertiesHandlers.FLAK_AUTOCANNON);

    public static final EntityEntry<MachineGunProjectile> MACHINE_GUN_BULLET =
        autocannonProjectile("machine_gun_bullet", MachineGunProjectile::new, CBCMunitionPropertiesHandlers.INERT_AUTOCANNON_PROJECTILE);
