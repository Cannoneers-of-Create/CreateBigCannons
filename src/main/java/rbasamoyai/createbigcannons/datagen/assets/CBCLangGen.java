...
public class CBCLangGen {
	...
	public static void prepare() {
        ...
        createEMITagTranslation(CBCCommonMetal.BRONZE.storageBlocks.items(), "Bronze Blocks");
        createEMITagTranslation(CBCCommonMetal.CAST_IRON.storageBlocks.items(), "Cast Iron Blocks");
        createEMITagTranslation(CBCCommonMetal.NETHERSTEEL.storageBlocks.items(), "Nethersteel Blocks");
		createEMITagTranslation(CBCCommonMetal.BRONZE.ingots, "Bronze Ingots");
		createEMITagTranslation(CBCCommonMetal.CAST_IRON.ingots, "Cast Iron Ingots");
		createEMITagTranslation(CBCCommonMetal.NETHERSTEEL.ingots, "Nethersteel Ingots");
		createEMITagTranslation(CBCCommonMetal.BRONZE.nuggets, "Bronze Nuggets");
		createEMITagTranslation(CBCCommonMetal.CAST_IRON.nuggets, "Cast Iron Nuggets");
		createEMITagTranslation(CBCCommonMetal.NETHERSTEEL.nuggets, "Nethersteel Nuggets");
