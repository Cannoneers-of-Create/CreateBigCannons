...
public class CBCCfgServer extends CBCConfigBase {
    ...
    public final CBCCfgCompat compat = nested(0, CBCCfgCompat::new, Comments.compat);
	...
	private static class Comments {
        ...
        static String compat = "These values affect server-side compatibility between Create Big Cannons and other mods.";
	}
