...
public class CBCCfgFailure extends ConfigBase {
	...
	public final ConfigFloat slidingBreechBurstChance = f(0.2f, 0.0f, 1.0f, "slidingBreechBurstChance", Comments.slidingBreechBurstChance);
	...
	private static class Comments {
		...
		static String[] slidingBreechBurstChance = new String[] {
				"Chance that a cannon will fail if a sliding breech cannon is loaded with too many Powder Charges. 0 is 0%, 1 is 100%.",
				"This chance can be affected by stronger and weaker charge blocks." };
