...
public class CBCCfgCannons extends ConfigBase {
	...
	public final ConfigInt weakBreechStrength = i(4, 0, "slidingBreechStrength", Comments.weakBreechStrength);
	...
	private static class Comments {
		...
		static String weakBreechStrength = "Maximum amount of Powder Charges that weak breech blocks can safely handle.";
