			...
			if (castProgressLerped != null) {
				...
				for (int l = 0; l < te.resultPreview.size(); ++l) {
					...
					for (Direction dir : Direction.values()) {
						rand.setSeed(42L);
						renderQuadList(ms.last(), vCons, 1f, 1f, 1f, alpha, model.getQuads(state, dir, rand, ModelUtil.VIRTUAL_DATA, null), light, overlay);
					}
					
					rand.setSeed(42L);
					renderQuadList(ms.last(), vCons, 1f, 1f, 1f, alpha, model.getQuads(state, null, rand, ModelUtil.VIRTUAL_DATA, null), light, overlay);
