...
public abstract class AbstractMountedCannonContraption extends Contraption {
	...
	public static AssemblyException incorrectBreechDirection(BlockPos pos) {
		return new AssemblyException(Component.translatable("exception." + CreateBigCannons.MOD_ID + ".cannon_mount.incorrectBreechDirection", pos.getX(), pos.getY(), pos.getZ()));
	}
