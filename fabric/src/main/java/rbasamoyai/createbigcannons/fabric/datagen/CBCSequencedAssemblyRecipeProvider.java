...
public class CBCSequencedAssemblyRecipeProvider extends CreateRecipeProvider {
	...
	FILLING_AUTOCANNON_CARTRIDGE = create("filling_autocannon_cartridge", b -> b.require(CBCItems.EMPTY_AUTOCANNON_CARTRIDGE.get())
		...
		.loops(3)
		.addStep(DeployerApplicationRecipe::new, rb -> rb.require(CBCTags.CBCItemTags.GUNPOWDER))
	...
	ASSEMBLING_MACHINE_GUN_ROUND = create("assembling_machine_gun_round", b -> b.require(CBCItems.EMPTY_MACHINE_GUN_ROUND.get())
		...
		.loops(1)
		.addStep(DeployerApplicationRecipe::new, rb -> rb.require(CBCTags.CBCItemTags.GUNPOWDER))
		.addStep(DeployerApplicationRecipe::new, rb -> rb.require(CBCTags.CBCItemTags.NUGGET_COPPER))
	...
	CAST_IRON_AUTOCANNON_BREECH_EXTRACTOR = create("cast_iron_autocannon_breech_extractor", b -> b.require(CBCTags.CBCItemTags.INGOT_CAST_IRON)
	...
	BRONZE_AUTOCANNON_BREECH_EXTRACTOR = create("bronze_autocannon_breech_extractor", b -> b.require(CBCTags.CBCItemTags.INGOT_BRONZE)
	...
	STEEL_AUTOCANNON_BREECH_EXTRACTOR = create("steel_autocannon_breech_extractor", b -> b.require(CBCTags.CBCItemTags.INGOT_STEEL)
