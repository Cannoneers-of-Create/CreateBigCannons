...
public class CBCMixingRecipeProvider extends ProcessingRecipeGen {
    ...
    ALLOY_BRONZE_TIN = create(CreateBigCannons.resource("alloy_bronze_tin"), b -> b.withCondition(DefaultResourceConditions.itemTagsPopulated(CommonMetal.TIN.ingots))
