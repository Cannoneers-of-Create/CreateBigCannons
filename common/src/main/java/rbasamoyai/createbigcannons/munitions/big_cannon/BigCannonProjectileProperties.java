...
public class BigCannonProjectileProperties extends BaseProjectileProperties {
	...
	private final int addedChargePower;
	...
	public BigCannonProjectileProperties(String id, JsonObject obj) {
		super(id, obj);
		this.addedChargePower = Math.max(0, GsonHelper.getAsInt(obj, "added_charge_power", 0));
	...
	public BigCannonProjectileProperties(FriendlyByteBuf buf) {
		super(buf);
		this.addedChargePower = buf.readVarInt();
	...
	public void toNetwork(FriendlyByteBuf buf) {
		super.toNetwork(buf);
		buf.writeVarInt(this.addedChargePower)
			.writeFloat(this.minimumChargePower)
			.writeBoolean(this.canSquib)
			.writeFloat(this.addedRecoil);
	}

	public int addedChargePower() { return this.addedChargePower; }
