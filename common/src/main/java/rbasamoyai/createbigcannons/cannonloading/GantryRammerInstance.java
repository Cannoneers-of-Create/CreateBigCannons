...
public class GantryRammerInstance extends ShaftInstance<GantryRammerBlockEntity> implements DynamicInstance {
	...
	public GantryRammerInstance(MaterialManager materialManager, GantryRammerBlockEntity blockEntity) {
		...
		facing = blockState.getValue(GantryRammerBlock.FACING);
		alongFirst = blockState.getValue(GantryRammerBlock.AXIS_ALONG_FIRST_COORDINATE);
