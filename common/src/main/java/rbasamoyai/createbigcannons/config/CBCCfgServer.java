...
public class CBCCfgServer extends CBCConfigBase {
	...
	public final CBCCfgComputerCraft computercraft = nested(0, CBCCfgComputerCraft::new, Comments.computercraft);
	...
	private static class Comments {
		...
		static String computercraft = "These values affect computercraft integration";
	}
