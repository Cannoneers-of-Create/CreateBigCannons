...
public class CBCMixingRecipeProvider extends ProcessingRecipeGen {
	...
	GeneratedRecipe
		...
		ALLOY_NETHERSTEEL_CAST_IRON = create(CreateBigCannons.resource("alloy_nethersteel_cast_iron"), b -> nethersteelAlloy(b, CBCTags.CBCItemTags.INGOT_CAST_IRON, 8, 8)),

	ALLOY_NETHERSTEEL_STEEL = create(CreateBigCannons.resource("alloy_nethersteel_steel"), b -> nethersteelAlloy(b, CBCTags.CBCItemTags.INGOT_STEEL, 4, 8)),
