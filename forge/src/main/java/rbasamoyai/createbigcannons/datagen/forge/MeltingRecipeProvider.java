...
public class MeltingRecipeProvider extends ProcessingRecipeGen {
	...
	public MeltingRecipeProvider(PackOutput output) {
	...
	GeneratedRecipe
		...
		.withCondition(new NotCondition(new TagEmptyCondition(CBCTags.CBCItemTags.BLOCK_CAST_IRON.location())))
	...
	MELT_CAST_IRON_INGOT = create(CreateBigCannons.resource("melt_cast_iron_ingot"), b -> b
        .withCondition(new NotCondition(new TagEmptyCondition(CBCTags.CBCItemTags.INGOT_CAST_IRON.location())))
	...
	MELT_CAST_IRON_NUGGET = create(CreateBigCannons.resource("melt_cast_iron_nugget"), b -> b
        .withCondition(new NotCondition(new TagEmptyCondition(CBCTags.CBCItemTags.NUGGET_CAST_IRON.location())))
	...
	MELT_BRONZE_BLOCK = create(CreateBigCannons.resource("melt_bronze_block"), b -> b
        .withCondition(new NotCondition(new TagEmptyCondition(CBCTags.CBCItemTags.BLOCK_BRONZE.location())))
	...
	MELT_BRONZE_INGOT = create(CreateBigCannons.resource("melt_bronze_ingot"), b -> b
		.withCondition(new NotCondition(new TagEmptyCondition(CBCTags.CBCItemTags.INGOT_BRONZE.location())))
	...
	MELT_BRONZE_NUGGET = create(CreateBigCannons.resource("melt_bronze_nugget"), b -> b
		.withCondition(new NotCondition(new TagEmptyCondition(CBCTags.CBCItemTags.NUGGET_BRONZE.location())))
	...
	MELT_STEEL_BLOCK = create(CreateBigCannons.resource("melt_steel_block"), b -> b
		.withCondition(new NotCondition(new TagEmptyCondition(CBCTags.CBCItemTags.BLOCK_STEEL.location())))
	...
	MELT_STEEL_INGOT = create(CreateBigCannons.resource("melt_steel_ingot"), b -> b
		.withCondition(new NotCondition(new TagEmptyCondition(CBCTags.CBCItemTags.INGOT_STEEL.location())))
	...
	MELT_STEEL_NUGGET = create(CreateBigCannons.resource("melt_steel_nugget"), b -> b
		.withCondition(new NotCondition(new TagEmptyCondition(CBCTags.CBCItemTags.NUGGET_STEEL.location())))
	...
	MELT_NETHERSTEEL_BLOCK = create(CreateBigCannons.resource("melt_nethersteel_block"), b -> b
		.withCondition(new NotCondition(new TagEmptyCondition(CBCTags.CBCItemTags.BLOCK_NETHERSTEEL.location())))
	...
	MELT_NETHERSTEEL_INGOT = create(CreateBigCannons.resource("melt_nethersteel_ingot"), b -> b
		.withCondition(new NotCondition(new TagEmptyCondition(CBCTags.CBCItemTags.INGOT_NETHERSTEEL.location())))
	...
	MELT_NETHERSTEEL_NUGGET = create(CreateBigCannons.resource("melt_nethersteel_nugget"), b -> b
		.withCondition(new NotCondition(new TagEmptyCondition(CBCTags.CBCItemTags.NUGGET_NETHERSTEEL.location())))
